...
void hash_trees_parallel_chains(struct tree *dst, const struct tree *src, int count, int chainlen);

/*Hashing ciphers*/
#define treecmp(a,b) memcmp((a)->h, (b)->h, TREE_SIZE)

#define treecmpN(a,b,N) memcmp((a)->h, (b)->h, (N)*TREE_SIZE)
